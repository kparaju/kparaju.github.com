...
\moveleft.5\hoffset\centerline{109 Gatewater Ct}
\moveleft.5\hoffset\centerline{Morrisville, NC 27560}
...
\section{SKILLS} {\sl Languages:} PHP, HTML/CSS, JavaScript, SQL,
                ...
                {\sl Technologies:} MySQL, Doctrine, Zend, KVM, SCSS, Git, Mercurial, vCloud
 

\section{EXPERIENCE} 
                {\sl Software Engineer Co-op} \hfill Aug 2011 - Aug 2014 \\
                ...
                \item
                  Worked on an agile development team with fast releases and customer-driven requirements
                \end{itemize}
